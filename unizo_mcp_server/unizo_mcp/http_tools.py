...
logger = logging.getLogger("unizo_mcp")
...
def _create_http_tool_function(function_template: Callable, properties: Dict[str, Any],
                               additional_variables: Dict[str, Any]) -> Callable:
...
def create_http_tool(
    ...
    http_tool_function = _create_http_tool_function(http_tool_function_template, properties,
                                                    additional_variables)  # type: ignore
